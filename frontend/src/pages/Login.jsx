...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      let url = currentState === "Sign Up" ? `${backendUrl}/api/user/register` : `${backendUrl}/api/user/login`
        ...
        <form onSubmit={onSubmitHandler} className="w-full flex flex-col gap-6">
          <div className="text-center mb-4">
            <motion.h2 
              ...
              className="text-4xl font-bold text-zinc-900 tracking-tight uppercase prata-font"
            >
              {currentState}
            </motion.h2>
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            disabled={loading}
            className="w-full bg-black text-white py-5 rounded-2xl shadow-xl hover:shadow-2xl transition-all font-bold text-xs uppercase tracking-[0.25em] mt-2 disabled:opacity-60"
          >
          ...
          <motion.button
            ...
            className="w-full bg-white border border-zinc-100 px-6 py-4 rounded-2xl shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-4 group disabled:opacity-60"
          >
